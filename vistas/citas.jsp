...
<!--                                <li><a href="#"><i class="fa fa-archive"></i>Categorias</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="#"><i class="fa fa-tags"></i>Administrar Citass</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <a href="srvCita?accion=nuevo" class="btn btn-success">
                        <i class="fa fa-plus"></i> Nuevo Cita </a>
                            ...
                            <div class="table-responsive" >                                 
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaCitas" class="display">
                                    ...
                                    <tr>
                                        ...
                                        <td>P001</td>
                                        <td>2020-05-20</td>
                                        <td><span class="badge bg-green active">Cita Activada</span></td> 
                                        <td>
                                            <button type="button" class="btn btn-warning" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
                                                        <i class="fa fa-pencil"></i></button>                                   
                                                        <a id="desactivarUsuario" class="btn btn-danger"  data-toggle="tooltip" title="Desactivar" data-original-title="Desactivar">
                                    ...
                                    <tr>
                                        ...
                                        <td>P003</td>
                                        <td>2020-04-01</td>
                                        <td><span class="badge bg-red active">Cita Inactiva</span></td>
                                        <td>
                                            <button type="button" class="btn btn-warning" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
                                                        <i class="fa fa-pencil"></i></button>                                   
                                                        <a id="activarUsuario" class="btn btn-primary" data-toggle="tooltip" title="Activar" data-original-title="Activar">
