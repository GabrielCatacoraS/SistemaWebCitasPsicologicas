                    ...
                    <div class="box">
                        ...
                        <form class="form-horizontal" action="srvUsuario?accion=registrar" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: Gabriel" name="txtNombre" maxlength="10"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="password" class="form-control" placeholder="Ejem: $%Gabo!**" name="txtClave" maxlength="10"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="box-footer">
                                <button type="reset" class="btn btn-danger" id="" name="btnCancelar" value="Cancelar" ><i class="fa fa-close red"></i><a href="srvUsuario?accion=listarUsuarios" ></a> Cancelar</button>
